...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Welcome to Meme Generator Application!")

    parser.add_argument('--path',   type=str, default=None, help="image file path")
    parser.add_argument('--body',   type=str, default=None, help="body to add to the image")
    parser.add_argument('--author', type=str, default=None, help="author to add to the image")
